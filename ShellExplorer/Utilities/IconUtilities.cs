...
namespace ShellExplorer.Utilities
{
    public sealed class IconUtilities
    {
        ...
        public static IntPtr GetIconHandleFromImageList(string path, SHIL shil)
        {
            ...
            _ = Methods.SHCreateItemFromParsingName(path, ctx, typeof(IShellItem).GUID, out var obj);
            if (obj == null)
                return IntPtr.Zero;
        ...
        internal static IntPtr GetIconHandleFromImageList(IShellItem item, SHIL shil)
        {
            ...
            var index = Methods.SHMapPIDLToSystemImageListIndex(psf, child, out _);
        ...
        private static IImageList GetImageList(SHIL shil) { _ = Methods.SHGetImageList(shil, typeof(IImageList).GUID, out var ilist); return ilist; }
